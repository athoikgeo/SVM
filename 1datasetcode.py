...
#Έχω βάλει το PCA σε σχόλιο για να κανω υπολογισμούς με και χωρίς pca
...
print("Ταξινόμηση των δεδομένων και υπολογισμός της απόδοσης της ταξινόμησης")
...
print("εσφαλμένη κατηγοριοποίηση")
